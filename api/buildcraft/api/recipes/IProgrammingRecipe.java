...
public interface IProgrammingRecipe extends Recipe<Container> {
    public static final ResourceLocation TYPE_ID = new ResourceLocation(BCModules.SILICON.getModId(), "programming");

    public static final RecipeType<IProgrammingRecipe> TYPE = RecipeType.register(TYPE_ID.toString());
